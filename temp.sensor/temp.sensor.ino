...
void loop() {
    ...
    // Stay reachable for OTA while we wait for the next sample. Polling
    // at ~5 Hz keeps OTA latency low without burning CPU; total pause
    // is still ~SAMPLE_INTERVAL_MS.
