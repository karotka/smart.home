...
RANGE_HEATING_TARGET_TEMP   = (15, 50)    # P05 (manual ceiling). Above 50 °C the heating water
                                          # pressure rises past what the expansion vessel can absorb,
                                          # the heat pump trips on a high-pressure fault and shuts
                                          # down; treat 50 as a hard safety limit.
...
def battery_packs(**kwargs):
    ...
    for measurement in names:
        ...
        out.append({
            ...
            "balancing":     point.get("balancing"),
            "charge_mos":    point.get("charge_mos"),
            "discharge_mos": point.get("discharge_mos"),
            "cells":         cells,
